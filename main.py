...
# Create trigger for Sunday to Thursday
weekday_trigger = CronTrigger(day_of_week="sun-thu", hour="10-14", minute="*/15") | \
                  CronTrigger(day_of_week="sun-thu", hour="15", minute="0-14/15")
